about_tab <- tabItem(tabName="about",
  ...
  fluidRow(
    box(
      ...
      "sequence. This deletion is described in the corresponding dataset by",
    ...
    box(
      ...
      tags$ol(
        ...
        tags$li(tags$b("Inspect single datapoint"),
          ": Gives detailed information about a single entry of the data set.",
          "Entry needs to be selected at the bottom of the 'Dataset overview'",
          "tab"
        ),
        tags$li(tags$b("Select segment"),
          ": This selection lets the user decide which of the eight segments",
          "will be used in the following four tabs."
        ),
    ...
    box(
      ...
      "driving factor in the generation of DI RNAs.",
      br(),
